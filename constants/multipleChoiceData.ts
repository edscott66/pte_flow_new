export const MULTIPLE_CHOICE_QUESTIONS = [
{
  ...
  text: "Many people start their day with a simple morning routine. They may eat breakfast, take a shower, or go for a short walk. A good routine helps people feel ready for the day. Some people also check the news or listen to music before leaving home.",
  options: [
    { id: 'A', text: "A morning routine helps people prepare for the day." },
    { id: 'B', text: "Some people take a walk in the morning." },
    { id: 'C', text: "Everyone listens to music in the morning." },
...
},
{
  ...
  options: [
    { id: 'A', text: "Libraries offer free classes." },
    { id: 'B', text: "Visitors must return items on time." },
    { id: 'C', text: "Libraries only allow adults to enter." },
...
},
{
  ...
  text: "Healthy snacks give people energy during the day. Many people choose fruit, nuts, or yogurt because they are easy to carry. Drinking water with snacks helps the body stay hydrated. Eating too many sweet snacks can make people feel tired later.",
  options: [
    { id: 'A', text: "Healthy snacks give people energy." },
    { id: 'B', text: "Fruit and nuts are common healthy snacks." },
    { id: 'C', text: "Drinking water helps the body stay hydrated." },
...
},
{
  id: '4',
  title: 'Public Parks',
  text: "Public parks are popular places for families and friends. People can walk, play sports, or relax on the grass. Many parks have benches and small cafés. Some parks also offer free events on weekends.",
  options: [
    { id: 'A', text: "People can relax in public parks." },
    { id: 'B', text: "Some parks offer free weekend events." },
    { id: 'C', text: "Parks never have cafés." },
...
},
{
  ...
  text: "Weather forecasts help people plan their day. They show information about temperature, rain, and wind. Many people check the weather on their phones before going outside. Forecasts are usually correct, but sometimes the weather changes suddenly.",
  options: [
    { id: 'A', text: "Forecasts show temperature and rain." },
    { id: 'B', text: "People often check the weather on their phones." },
    { id: 'C', text: "Weather never changes suddenly." },
...
},
{
  id: '6',
  title: 'School Clubs',
  text: "Many schools offer clubs after class. Students can join music clubs, sports teams, or art groups. Clubs help students make friends and learn new skills. Some clubs meet once a week, while others meet more often.",
  options: [
    { id: 'A', text: "Students can join different types of clubs." },
    { id: 'B', text: "Clubs help students make friends." },
    { id: 'C', text: "Some clubs meet weekly." },
...
},
{
  ...
  text: "Recycling helps reduce waste and protect the environment. Many homes have separate bins for paper, plastic, and glass. People should clean containers before recycling them. Some cities collect recycling once a week.",
  options: [
    { id: 'A', text: "Recycling helps reduce waste." },
    { id: 'B', text: "Homes often separate materials." },
    { id: 'C', text: "Containers should be cleaned before recycling." },
...
},
{
  ...
  text: "Public transport includes buses, trains, and trams. It is often cheaper than driving a car. Many people use transport cards to pay for their trips. Some cities offer discounts for students and older adults.",
  options: [
    { id: 'A', text: "Public transport includes buses and trains." },
    { id: 'B', text: "Transport cards are used for payment." },
    { id: 'C', text: "Public transport is always more expensive." },
...
},
{
  ...
  text: "Cooking at home can save money and help people eat healthier meals. Many families cook simple dishes like soup, rice, or pasta. Some people enjoy trying new recipes. Cooking together can also be a fun activity for families.",
  options: [
    { id: 'A', text: "Cooking at home can save money." },
    { id: 'B', text: "Families often cook simple dishes." },
    { id: 'C', text: "Trying new recipes can be enjoyable." },
...
},
{
  ...
  text: "Museums show art, history, and science exhibits. Many museums offer free entry on certain days. Visitors should follow rules such as not touching the displays. Audio guides are available in several languages.",
  options: [
    { id: 'A', text: "Museums show art and history." },
    { id: 'B', text: "Some museums offer free entry." },
    { id: 'C', text: "Visitors should not touch displays." },
...
{
  id: '44',
  title: 'The Importance of Cultural Festivals',
...
{
  id: '56',
  title: 'The Role of Public Art in Cities',
...
{
  id: '101',
  title: 'The Ethics of Artificial Intelligence in Hiring',
  text: "As companies increasingly rely on artificial intelligence to screen job applications, concerns about fairness and transparency have become more prominent. AI systems can analyse thousands of résumés quickly, identifying patterns that may predict job performance. However, these systems are only as unbiased as the data used to train them. If historical hiring practices favoured certain groups, the AI may unintentionally repeat those patterns, disadvantaging qualified candidates. Critics argue that companies must disclose how their algorithms make decisions, while supporters claim AI reduces human error and speeds up recruitment. As the technology evolves, organisations face the challenge of balancing efficiency with ethical responsibility, ensuring that automated tools support equal opportunities rather than reinforce existing inequalities.",
  options: [
    { id: 'A', text: "AI can unintentionally repeat biased hiring patterns." },
    { id: 'B', text: "AI systems analyse large numbers of applications quickly." },
    { id: 'C', text: "AI guarantees completely fair hiring decisions." },
    { id: 'D', text: "Companies must consider ethical responsibilities." },
    { id: 'E', text: "AI removes the need for human involvement entirely." }
  ],
  correctOptions: ['A', 'B', 'D']
},
{
  id: '102',
  title: 'The Decline of Traditional News Consumption',
  text: "Traditional news consumption has declined sharply as more people turn to digital platforms for information. Online news offers instant updates, personalised recommendations, and interactive features that printed newspapers cannot match. However, the shift to digital media has raised concerns about misinformation, as many users struggle to distinguish credible sources from unreliable ones. Social media algorithms often prioritise attention‑grabbing content, which can distort public understanding of important issues. Despite these challenges, traditional journalism still plays a vital role in providing verified, in‑depth reporting. The future of news may depend on finding a balance between digital convenience and the rigorous standards of professional journalism.",
  options: [
    { id: 'A', text: "Digital platforms offer instant news updates." },
    { id: 'B', text: "Social media algorithms can distort public understanding." },
    { id: 'C', text: "Printed newspapers provide interactive features." },
...
{
  id: '103',
  title: 'The Challenges of Global Water Management',
  text: "Global water management has become increasingly complex as climate change, population growth, and industrial expansion place pressure on freshwater supplies. Many regions face severe droughts, while others struggle with flooding caused by unpredictable weather patterns. Governments and environmental organisations are working to develop sustainable water strategies, including improved irrigation systems, desalination technologies, and stricter pollution controls. However, these solutions require significant investment and international cooperation, which can be difficult to achieve. Without coordinated action, water scarcity may intensify conflicts, disrupt agriculture, and threaten public health. Effective water management will depend on long‑term planning and a shared commitment to protecting this essential resource.",
  options: [
    { id: 'A', text: "Climate change increases pressure on water supplies." },
    { id: 'B', text: "Some regions face drought while others face flooding." },
    { id: 'C', text: "Sustainable water strategies require investment." },
    { id: 'D', text: "Water scarcity may lead to conflict." },
    { id: 'E', text: "Water management is unaffected by population growth." }
  ],
  correctOptions: ['A', 'B', 'C', 'D']
},
{
  id: '104',
  title: 'The Influence of Corporate Culture on Innovation',
  text: "Corporate culture plays a crucial role in determining how effectively a company can innovate. Organisations that encourage open communication, risk‑taking, and collaboration often generate more creative ideas than those with rigid hierarchies. When employees feel safe to share unconventional suggestions, they are more likely to challenge outdated processes and propose new solutions. However, fostering innovation requires more than simply encouraging creativity; companies must also provide resources, training, and leadership support. Without these elements, even the most enthusiastic teams may struggle to turn ideas into practical outcomes. A strong innovation culture can help businesses adapt to changing markets and maintain a competitive edge.",
  options: [
    { id: 'A', text: "Open communication supports innovation." },
    { id: 'B', text: "Rigid hierarchies can limit creativity." },
    { id: 'C', text: "Innovation requires resources and leadership support." },
...
{
  id: '105',
  title: 'The Social Impact of Remote Work Migration',
  text: "As remote work becomes more common, many professionals are relocating from major cities to smaller towns or rural areas. This migration can revitalise local economies by increasing demand for housing, services, and community activities. However, it may also create tensions if long‑term residents feel priced out by newcomers with higher incomes. Local governments must balance economic growth with policies that protect affordable housing and preserve community identity. Remote workers, meanwhile, must adapt to different social expectations and contribute positively to their new environments. The long‑term impact of remote work migration will depend on how well communities manage these changes.",
  options: [
    { id: 'A', text: "Remote workers are moving to smaller towns." },
    { id: 'B', text: "Migration can increase local economic activity." },
    { id: 'C', text: "Newcomers always lower housing prices." },
...
},
{
  ...
  text: "Autonomous transportation is rapidly advancing as improvements in artificial intelligence, sensor technology, and digital mapping make self‑driving vehicles more reliable. Supporters argue that autonomous cars could reduce accidents caused by human error, ease traffic congestion, and provide mobility for people unable to drive. However, significant challenges remain, including regulatory uncertainty, cybersecurity risks, and the ethical dilemmas involved in programming decision‑making systems. Critics also worry about job losses in industries such as trucking and taxi services. Despite these concerns, many experts believe autonomous transportation will eventually become a major part of modern infrastructure, transforming how people and goods move across cities.",
  options: [
    { id: 'A', text: "Autonomous vehicles may reduce accidents." },
    { id: 'B', text: "Cybersecurity is a major concern for self‑driving cars." },
    { id: 'C', text: "Autonomous transportation eliminates all ethical dilemmas." },
    { id: 'D', text: "Job losses are a concern in certain industries." },
    { id: 'E', text: "Autonomous vehicles rely on advanced sensors." }
  ],
  correctOptions: ['A', 'B', 'D', 'E']
},
{
  id: '107',
  title: 'The Psychology Behind Consumer Loyalty',
  text: "Consumer loyalty is shaped by a combination of emotional, psychological, and practical factors. While competitive pricing and product quality are important, many customers remain loyal to brands that make them feel understood and valued. Companies often use personalised marketing, reward programs, and consistent customer service to strengthen these emotional connections. Trust also plays a significant role; when consumers believe a brand is reliable and transparent, they are more likely to return. However, loyalty can be fragile, especially if a company fails to meet expectations or faces public criticism. Understanding the psychology behind loyalty helps businesses create long‑term relationships with their customers.",
  options: [
    { id: 'A', text: "Emotional connection influences consumer loyalty." },
    { id: 'B', text: "Trust increases the likelihood of repeat purchases." },
    { id: 'C', text: "Reward programs can strengthen loyalty." },
...
},
{
  ...
  text: "Universal Basic Income (UBI) is a policy proposal in which all citizens receive a regular, unconditional payment from the government. Supporters argue that UBI could reduce poverty, simplify welfare systems, and provide financial stability in an era of automation. Critics, however, question its affordability and worry that guaranteed income might reduce motivation to work. Some pilot programs have shown positive results, such as improved mental health and increased entrepreneurial activity, but long‑term effects remain uncertain. As economies continue to evolve, the debate over UBI highlights broader questions about fairness, productivity, and the future of social support systems.",
  options: [
    { id: 'A', text: "UBI provides unconditional payments to citizens." },
    { id: 'B', text: "Critics question the affordability of UBI." },
    { id: 'C', text: "Pilot programs show only negative results." },
...
{
  id: '109',
  title: 'The Environmental Cost of Global Shipping',
  text: "Global shipping is essential for international trade, but it also has significant environmental consequences. Large cargo ships burn heavy fuel oil, producing high levels of carbon emissions and air pollution. Shipping routes can also disrupt marine ecosystems, particularly when invasive species are transported in ballast water. Efforts to reduce the environmental impact include developing cleaner fuels, improving ship design, and implementing stricter international regulations. However, these solutions require global cooperation and substantial investment. As demand for global trade continues to grow, balancing economic needs with environmental responsibility remains a major challenge.",
  options: [
    { id: 'A', text: "Cargo ships contribute to carbon emissions." },
    { id: 'B', text: "Shipping can disrupt marine ecosystems." },
    { id: 'C', text: "Cleaner fuels may reduce environmental impact." },
    { id: 'D', text: "Global cooperation is needed for effective solutions." },
    { id: 'E', text: "Shipping has no environmental consequences." }
  ],
  correctOptions: ['A', 'B', 'C', 'D']
},
{
  ...
  text: "Global media has reshaped cultural exchange by allowing people to access films, music, and news from around the world instantly. While this increased exposure promotes understanding and appreciation of different cultures, it also raises concerns about cultural homogenisation. Smaller or less dominant cultures may struggle to preserve their traditions when global media platforms prioritise mainstream content. At the same time, digital distribution has given independent creators new opportunities to reach international audiences. The cultural impact of global media is therefore complex, offering both enrichment and challenges as societies navigate the balance between global influence and local identity.",
  options: [
    { id: 'A', text: "Global media increases cultural exchange." },
    { id: 'B', text: "Some cultures struggle to preserve traditions." },
    { id: 'C', text: "Digital platforms help independent creators reach audiences." },
...
{
  id: '114',
  title: 'The Cultural Influence of Global Tourism',
...
{
  id: '124',
  title: 'The Role of Public Libraries in Digital Inclusion',
...
{
  id: '130',
  title: 'The Ethical Questions Surrounding Facial Recognition',
...
},
{
  ...
  text: "Citizen journalism has expanded rapidly with the growth of smartphones and social media, allowing ordinary individuals to document events in real time. Supporters argue that citizen reporting increases transparency, especially in situations where traditional media cannot respond quickly. However, the lack of professional training raises concerns about accuracy, bias, and the spread of unverified information. Some experts believe that citizen journalism should complement, rather than replace, traditional reporting, which relies on established editorial standards. As digital platforms continue to evolve, the relationship between professional journalists and citizen reporters remains a subject of ongoing debate.",
  options: [
...
{
  id: '144',
  title: 'The Role of Public Art in Urban Regeneration',
...
},
{
  ...
  options: [
    ...
    { id: 'C', text: "Universal access always improves academic standards." },
